...
func (o *AlbumListOK) WithPayload(payload *models.InlineResponse2006) *AlbumListOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the album list o k response
func (o *AlbumListOK) SetPayload(payload *models.InlineResponse2006) {
	o.Payload = payload
}
