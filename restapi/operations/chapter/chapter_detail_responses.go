...
func (o *ChapterDetailOK) WithPayload(payload *models.InlineResponse20017) *ChapterDetailOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the chapter detail o k response
func (o *ChapterDetailOK) SetPayload(payload *models.InlineResponse20017) {
	o.Payload = payload
}
