...
func (o *CategoryDetailOK) WithPayload(payload *models.InlineResponse20022) *CategoryDetailOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the category detail o k response
func (o *CategoryDetailOK) SetPayload(payload *models.InlineResponse20022) {
	o.Payload = payload
}
