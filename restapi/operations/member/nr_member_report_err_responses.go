...
func (o *MemberReportErrOK) WithPayload(payload *models.InlineResponse2008) *MemberReportErrOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the member report err o k response
func (o *MemberReportErrOK) SetPayload(payload *models.InlineResponse2008) {
	o.Payload = payload
}
