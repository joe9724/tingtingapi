...
type MemberDetailOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.InlineResponse200155 `json:"body,omitempty"`
}
...
func (o *MemberDetailOK) WithPayload(payload *models.InlineResponse200155) *MemberDetailOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the member detail o k response
func (o *MemberDetailOK) SetPayload(payload *models.InlineResponse200155) {
	o.Payload = payload
}
